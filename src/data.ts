...
export const translations: Record<'ru' | 'ky' | 'en', Translation> = {
  ...
  ky: {
    title: "Нурзада",
    subtitle: "Кыз узатуу",
    hostsInvitation: "Кадырлуу коногубуз, Кызыбыз Нурзадага «барар жеринен бак айтсын» деп бата тилеп турабыз. Сизди тун перзентибиздин кыз узатуу аземине келип, куттуу күндүн күбөсү болууга чакырабыз!",
    saveTheDateTitle: "Календарга белгилеңиз",
    saveTheDateDesc: "Бул күндү календарыңызда ❤️ менен белгилеп, жакшылыгыбызды тең бөлүшүп, кубанычыбызга ортоктош болуңуз.",
    calendarMonth: "СЕНТЯБРЬ 2026",
    calendarDays: {
      mon: "ДШ",
      tue: "ШШ",
    ...
    programItems: [
      ...
      { time: "17:30", title: "Салтанаттын расмий ачылышы" },
      { time: "", title: "Тойдун каада-салттары" },
      { time: "", title: "Каалоо-тилектер" },
      { time: "", title: "Шаңдуу кече — Оюн-зоок" },
